...
module "tunnel" {
source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/cloudflare/tunnel?ref=v2.5.11"
...
module "tunnel_dns" {
source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/cloudflare/dns-record?ref=v2.5.11"
...
source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/cloudflare/pages-project?ref=v2.5.11"
...
source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/cloudflare/pages-domain?ref=v2.5.11"
...
source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/cloudflare/worker-basic-auth?ref=v2.5.11"
