...
# ── Memorystore Redis ──
module "redis" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/gcp/data/memorystore-redis?ref=v2.3.7"
...
module "cloud_sql" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/gcp/data/cloud-sql?ref=v2.3.7"
