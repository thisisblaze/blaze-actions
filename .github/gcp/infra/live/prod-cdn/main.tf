...
# ── Label ──
module "label" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/common/label?ref=v2.2.16"
...
module "cloud_armor" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/gcp/security/cloud-armor?ref=v2.2.16"
...
module "image_resize" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/gcp/compute/image-resize?ref=v2.2.16"
...
module "global_lb" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/gcp/cdn/global-https-lb?ref=v2.2.16"
