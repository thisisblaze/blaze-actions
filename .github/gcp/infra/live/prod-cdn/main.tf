...
# ── Label ──
module "label" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/common/label?ref=v2.11.13"
...
module "cloud_armor" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/gcp/security/cloud-armor?ref=v2.11.13"
...
module "image_resize" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/gcp/compute/image-resize?ref=v2.11.13"
