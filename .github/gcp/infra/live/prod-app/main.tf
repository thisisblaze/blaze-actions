...
module "environment_app" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/gcp/compute/environment-app?ref=v2.7.0"
...
module "pages_project_admin" {
  ...
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/cloudflare/pages-project?ref=v2.7.0"
