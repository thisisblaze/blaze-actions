...
module "app_fleet" {
  source = "github.com/thisisblaze/blaze-terraform-infra-core//modules/gcp/compute/multi-site-app?ref=v2.6.2"
...
module "cloudflare_records" {
  source   = "github.com/thisisblaze/blaze-terraform-infra-core//modules/cloudflare/dns-records?ref=v2.6.2"
