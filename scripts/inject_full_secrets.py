...
SECRETS_LIST = [
    "BLAZE_ELASTICSEARCH_USERNAME", "BLAZE_ELASTICSEARCH_PASSWORD", "BLAZE_ELASTICSEARCH_ENDPOINT", "AWS_ROLE_ARN", "GCP_WORKLOAD_IDENTITY_PROVIDER", "GCP_SERVICE_ACCOUNT",
