...
> [!TIP]
> **Antigravity 2.0 Standard**: The legacy `docs/prompts` directory has been **deleted and deprecated**. All AI instructions, system prompts, and personas MUST reside in `.agents/workflows/` and `.github/agents/`. Agents must be invoked autonomously using these definitions.
